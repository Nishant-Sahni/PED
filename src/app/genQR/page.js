...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-start p-8 overflow-hidden">
  ...
  <h2 className="text-2xl font-bold text-gray-800 text-center mt-6">Recent Entries</h2>
      ...
      <tbody>
        {entries.map((entry) => (
          <tr key={entry.id} className="text-center">
            ...
            <td className="border border-gray-300 px-4 py-2">{entry.entryNumber}</td>
